@REM nablepjt-core launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM NABLEPJT_CORE_config.txt found in the NABLEPJT_CORE_HOME.
@setlocal enabledelayedexpansion

@echo off
if "%NABLEPJT_CORE_HOME%"=="" set "NABLEPJT_CORE_HOME=%~dp0\\.."
set ERROR_CODE=0

set "APP_LIB_DIR=%NABLEPJT_CORE_HOME%\lib\"
...
set "CFG_FILE=%NABLEPJT_CORE_HOME%\NABLEPJT_CORE_config.txt"
set CFG_OPTS=
if exist %CFG_FILE% (
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running nablepjt-core.
  echo.
